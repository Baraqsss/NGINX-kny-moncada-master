...
const Donate = () => {
    ...
    return (
        <div
            className="flex flex-col w-screen min-h-screen items-center justify-start bg-gray-100"
            style={{ overflow: "hidden", paddingTop: "2rem" }} // Added top padding
        >
            <div className="max-w-4xl w-full flex-grow flex flex-col justify-center mb-20">
                ...
                <div className="flex flex-col md:flex-row mt-4 flex-grow">
                    ...
                    {/* Right Section */}
                    <div className="md:ml-4 mt-4 md:mt-0 md:w-2/3 flex-grow">
